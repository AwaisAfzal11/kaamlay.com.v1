      ...
      <footer className="bg-gray-100">
        <div className="container mx-auto px-6 py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
              <h3 className="text-lg font-semibold text-black mb-4 uppercase tracking-wider">Our Projects</h3>
              <ul className="space-y-3">
                {projectLinks.map((project, index) => (
                  <li key={index}>
                    <Link
                      to={project.path}
                      className="text-gray-700 hover:text-[#BD872E] flex items-center gap-2 transition-colors text-sm"
                    >
                      <ChevronRight size={14} className="text-[#BD872E] flex-shrink-0" />
                      {project.name}
                    </Link>
                  </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-700">
                <li className="flex items-start">
                  ...
                  <span className="text-sm">Plot # 03, 04 & 05, Near Kiani House, Opposite ATTOCK Petrol Pump, DHA Phase 02, GT Road, Islamabad, Pakistan</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-6 mt-1">
                    <Mail className="h-5 w-5 text-[#BD872E]" />
                  </div>
                  <a href="mailto:zemaydar@gmail.com" className="hover:text-[#BD872E] transition-colors text-sm">
                    zemaydar@gmail.com
                  </a>
                </li>
                <li className="flex items-start">
                  ...
                  <a href="tel:+923331111114" className="hover:text-[#BD872E] transition-colors text-sm">
                    +92 333 111 111 4
                  </a>
                </li>
              </ul>
